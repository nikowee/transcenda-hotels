...
| `ProfileModal.test.tsx` | 13 | Vitest + RTL | `client/src/tests/` |
...
**source-level** count: 452 server, 205 client, 35 E2E. The runners report
**717** — 460 server, 222 client, 35 E2E — and the two reconcile exactly:
...
460); and `it.each` tables are not counted here at all — `CheckoutPage` (1) and
`PaymentPage` (3) expand to 17 cases (205 + 17 = 222). Regenerate rather than
hand-edit; every count in this file drifted before.*
